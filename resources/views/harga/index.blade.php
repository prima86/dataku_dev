@extends('layouts.main_layout', ['breadcrumb' => ['Info Harga']])
      ...
      <div class="card mb-2">
        <div class="card-header" style="background-color:#FFFFFF;">
          <div class="row no-gutters">
            <div class="col-md-1">
              <img src="{{asset('images/logo_pemkot_salatiga_300.png')}}" alt="..." class="img-thumbnail" style="border:0px; width:55px; margin-left: 3rem">
            </div>
            <div class="col-md-2" style="font-weight:bold;font-style:italic;">
              DINAS PERDAGANGAN<br/>KOTA SALATIGA
            </div>
            <div class="col-md-8">
              <img src="{{asset('images/home/info-harga.jpg')}}" alt="..." class="img-thumbnail" style="border:0px; width:180px; margin-top: 0rem;">
  ...
  <div class="row">
    ...
    <div class="col-sm-12 col-md-6 col-lg-4">
      <div class="card mb-2">
        ...
        <div class="card-body">
          <b>Last Updated : {{ina_date($tanggal)}}</b>
          <div class="table-responsive">
            <table class="table table-sm table-striped">
              ...
              @foreach ($result as $value)
                @if($value->nama_pasar === "PASAR REJOSARI")
                  <tr>
                    <td>{{$value->nama_komoditi}}</td>
                    <td class="text-right">{{number_format($value->harga)}}</td>
                  </tr>
                @endif
              @endforeach
            </table>
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <table class="table table-sm table-striped">
              ...
              @foreach ($result as $value)
                @if($value->nama_pasar === "PASAR BLAURAN")
                  <tr>
                    <td>{{$value->nama_komoditi}}</td>
                    <td class="text-right">{{number_format($value->harga)}}</td>
                  </tr>
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <table class="table table-sm table-striped">
              ...
              @foreach ($result as $value)
                @if($value->nama_pasar === "PASAR RAYA I")
                  <tr>
                    <td>{{$value->nama_komoditi}}</td>
                    <td class="text-right">{{number_format($value->harga)}}</td>
                  </tr>
