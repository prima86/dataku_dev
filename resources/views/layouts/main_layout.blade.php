...
<head>
  ...
  <link rel="icon" type="image/png"  href="{{asset('dataku/images/favicon.png')}}">
  
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" media="screen">
  <link rel="stylesheet" href="{{asset('dataku/css/bootstrap.min.css')}}" media="screen">
  <link rel="stylesheet" href="{{asset('dataku/css/dataku.css')}}">
  ...
  @if ($night_mode == 2)
    {{-- always --}}
    <link rel="stylesheet" href="{{asset('dataku/css/dataku_night_mode.css')}}">
  @elseif ($night_mode == 1)
    {{-- adapative --}}
    @php
  ...
  {{-- <link rel="stylesheet" href="{{asset('dataku/css/jquery.treeview.css')}}" /> --}}
...
<body style="">
  ...
  @if (is_array(@$breadcrumb))
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{url('home')}}" class="text-info">Home</a></li>
        @for ($i=0; $i < count($breadcrumb); $i++)
          <li class="breadcrumb-item text-info">{{$breadcrumb[$i]}}</li>
        @endfor
      </ol>
    </nav>
  @endif
        ...
        <!-- <div class="card text-center"> -->
          <div class="card-body">
            ...
            <a href="https://www.instagram.com/pemkotsalatiga/" target="_blank">
              <img src="{{asset('images/home/ig-logo.png')}}" alt="instagram" style="width: 35px;" data-toggle="tooltip" data-placement="right" title="facebook">
            </a>
            <a href="https://www.youtube.com/@pemkot_salatiga" target="_blank">
              <img src="{{asset('images/home/yt-logo.png')}}" alt="youtube" style="width: 35px;" data-toggle="tooltip" data-placement="right" title="facebook">
            </a>
            <a href="https://www.facebook.com/dinaskominfosala3/" target="_blank">
              <img src="{{asset('images/home/fb-logo.png')}}" alt="facebook" style="width: 35px;" data-toggle="tooltip" data-placement="right" title="facebook">
            </a>
            <a href="https://twitter.com/pemkot_salatiga" target="_blank">
              <img src="{{asset('images/home/tw-logo.png')}}" alt="twitter" style="width: 35px;" data-toggle="tooltip" data-placement="right" title="facebook">
            </a>
          </div>
        <!-- </div> -->
  ...
  <script src="{{asset('dataku/js/popper.min.js')}}"></script>
  <script src="{{asset('dataku/js/bootstrap.min.js')}}"></script>
  <script src="{{asset('app_plugins/bootbox/bootbox.min.js')}}"></script>
  <script src="{{asset('app_plugins/jquery.number/jquery.number.min.js')}}"></script>
  <script src="{{asset('dataku/js/thor.custom.js')}}"></script>

  {{-- <script src="{{asset('dataku/js/jquery.treeview.js')}}"></script> --}}
